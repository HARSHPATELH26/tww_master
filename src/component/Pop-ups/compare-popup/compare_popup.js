                                ...
                                <table id="product-table" className="product-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <a href="shop-details.html">Twin Hoops</a> <span className="remove">remove</span>
                                            </th>
                                            <th>
                                                <a href="shop-details.html">Medium Flat Hoops</a> <span className="remove">remove</span>
                                            </th>
                                            <th>
                                                <a href="shop-details.html">Bold Pearl Hoop Earrings</a> <span className="remove">remove</span>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr className="tr-image">
                                            ...
                                            <td>
                                                <a href="shop-details.html">
                                                    <img width="600" height="600" src={require("../../../asset/media/product/3.jpg")} alt="" />
                                                </a>
                                            </td>
                                            <td>
                                                <a href="shop-details.html">
                                                    <img width="600" height="600" src={require("../../../asset/media/product/1.jpg")} alt="" />
                                                </a>
                                            </td>
                                            <td>
                                                <a href="shop-details.html">
                                                    <img width="600" height="600" src={require("../../../asset/media/product/2.jpg")} alt="" />
                                                </a>
                                            </td>
                                        </tr>
                                        <tr className="tr-sku">
